            ...
            {(()=>{
                ...
                let emptyStarNumber = totalStarNumber - fullStarNumber - Math.ceil(halfStarNumber);
                 ...
                 let stars =[
                     ...(()=>{
                         if(fullStarNumber>0){
                             return new Array(fullStarNumber).fill(0).map((_,i)=><i style={{color}} key={`full-${i}`} className='fas fa-star'></i>)
                         } else{
                             return [];
                         }
                     })(),
                    ...(()=>{
                           if(halfStarNumber>=0.5){
                                return [<i key={`half-star`} style={{color}} className='fas fa-star-half-alt'></i>]
                           } else if(halfStarNumber<0.5 &&halfStarNumber>0 ){
                               return [<i style={{color}} key={`empty-star`} className='fas fa-star'></i>];
                           } else {
                               return [];
                           }
                    })(),
                    ...(()=>{
                        if(emptyStarNumber>0){
                            return new Array(emptyStarNumber).fill(0).map((_,i)=><i style={{color}} key={`last-star-${i}`}  className='far fa-star'></i>)   
                        } else {
                            return [];
                        }
                    })()
